 ...
 * 
 *         Programme to get the Nth element from a linked list
 * 
 ...
 *         one until reference pointer reaches end. Now main pointer will point
...
public class LinkedlistNthElement {
	...
	void printNthFromLast(int n) {
		...
		int count = 0;
		if (head != null) {
			// This is to maintain difference of n element
			while (count < n) {
				if (ref_ptr == null) {
	...
	public static void main(String[] args) {
		LinkedlistNthElement llist = new LinkedlistNthElement();
		llist.push(20);
		llist.push(4);
		llist.push(15);
		llist.push(35);
